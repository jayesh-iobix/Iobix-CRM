...
export default function Header() {
  ...
  const fetchHolidayDates = async () => {
    try {
      ...
      const expandedDates = holidays.flatMap((holiday) => {
        const start = new Date(holiday.holidayStartDate);
        const end = new Date(holiday.holidayEndDate);
        const dates = [];
  ...
  //         <div className="tooltip">{holiday.holidayName}</div>
  //       </div>
  //     );
  //   }
  // }
    ...
    <div className="bg-white h-16 px-4 flex items-center border-b m-2 rounded-full border-gray-200 shadow-sm shadow-[#d0ecfc] justify-between">
      ...
      <div className="flex items-center gap-2 mr-2">
        ...
        <div className="relative inline-block text-left">
          ...
          {tooltip.show && (
            <div
              className="fixed bg-gray-800 text-white text-xs px-2 py-1 rounded shadow"
              style={{
                top: `${tooltip.y}px`,
                left: `${tooltip.x}px`,
      ...
      {/* {tooltip.show && (
        <div
          className="fixed bg-gray-800 text-white text-sm px-2 py-1 rounded shadow"
          style={{
            top: `${tooltip.y}px`,
            left: `${tooltip.x}px`,
            transform: "translate(-50%, -100%)",
...
//           </button>
//           {showCalendar && (
//             <div className="absolute z-50 right-0 mt-2 rounded-xl">
...
//     leaveTo="opacity-0 scale-95"
//   >
//     <div ref={calendarRef} className="absolute z-50 right-0 mt-2 rounded-xl">
//       <Calendar
//         tileClassName={tileClassName}
//         tileContent={tileContent}
//       />
