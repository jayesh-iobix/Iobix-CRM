...
//       const countries = await CommonService.getCountry();
...
//   const validateForm = () => {
//     const errors = {};
//     const requiredFields = ["companyName", "contactPersonName", "email", "phoneNumber", "address", "countryId"];
...
//       deviceOSName: os.name || "Unknown",
//       deviceOSVersion: os.version || "Unknown",
//     };

//     const vendorData = { ...formData, stateId: formData.stateId || 0, cityId: formData.cityId || 0, deviceInfoVM };
//     setIsSubmitting(true);

//     try {
//       const response = await VendorService.addVendor(vendorData);
//       if (response.status === 1) toast.success("Registration successful!");
//       if (response.status === 0) toast.error("This email is already registered");
//     } catch (error) {
...
//       <form onSubmit={handleSubmit} className="form-container w-full lg:w-[700px] md:w-[600px] flex flex-col gap-y-8 bg-white px-10 pt-14 pb-14 shadow-lg rounded-md">
//         <p className="text-[#F9A01B] text-2xl font-bold text-center">Vendor Registration Form</p>

//         <div className="flex flex-col gap-y-5">
//           {["companyName", "companyRegistrationNumber", "email", "contactPersonName"].map((field) => (
//             <div className="w-full flex flex-col gap-1" key={field}>
//               <label htmlFor={field} className="text-slate-700 m-2">{field.replace(/([A-Z])/g, ' $1')}</label>
//               <input
//                 type="text"
//                 name={field}
//                 value={formData[field]}
//                 onChange={handleChange}
//                 className="bg-transparent px-3 py-2.5 border border-gray-300 w-full rounded-full"
//               />
...
//           <div className="flex gap-4">
//             <div className="w-full flex flex-col gap-1">
//               <label htmlFor="phoneNumber" className="text-slate-700 m-2">Phone Number</label>
//               <input
//                 type="tel"
//                 name="phoneNumber"
//                 value={formData.phoneNumber}
...
//             <div className="w-full flex flex-col gap-1">
//               <label htmlFor="whatsAppNumber" className="text-slate-700 m-2">WhatsApp Number</label>
//               <input
//                 type="tel"
//                 name="whatsAppNumber"
//                 value={formData.whatsAppNumber}
...
//           <div className="flex gap-4">
//             <div className="w-full flex flex-col gap-1">
//               <label htmlFor="countryId" className="text-slate-700 m-2">Country</label>
//               <select name="countryId" value={formData.countryId} onChange={handleChange} className="bg-transparent px-3 py-2.5 border border-gray-300 w-full rounded-full">
...
//             <div className="w-full flex flex-col gap-1">
//               <label htmlFor="stateId" className="text-slate-700 m-2">State</label>
//               <select name="stateId" value={formData.stateId} onChange={handleChange} className="bg-transparent px-3 py-2.5 border border-gray-300 w-full rounded-full">
...
//           <div className="flex gap-4">
//             <div className="w-full flex flex-col gap-1">
//               <label htmlFor="cityId" className="text-slate-700 m-2">City</label>
//               <select name="cityId" value={formData.cityId} onChange={handleChange} className="bg-transparent px-3 py-2.5 border border-gray-300 w-full rounded-full">
...
//             <div className="w-full flex flex-col gap-1">
//               <label htmlFor="address" className="text-slate-700 m-2">Address</label>
//               <input
//                 type="text"
//                 name="address"
//                 value={formData.address}
...
//           <button type="submit" className={`w-full h-10 bg-[#0074BD] text-white rounded-full ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`} disabled={isSubmitting}>
//             {isSubmitting ? "Submitting..." : "Register"}
//           </button>
//         </div>
//       </form>
