...
// const InquiryChat = ({ inquiryId, chatPersoneName, selectedPersonId }) => {
//   const [messages, setMessages] = useState([]); // State to store messages
//   const [newMessage, setNewMessage] = useState(""); // State to store new message
//   const [file, setFile] = useState(null); // State to store selected file
//   const [connection, setConnection] = useState(null); // For the SignalR connection
...
//       const chatData = await InquiryChatService.getChatInAdmin(inquiryId, selectedPersonId);
//       setMessages(chatData.data);
//       console.log(chatData);
//     };
//     fetchData();
//   }, [inquiryId, selectedPersonId]);
...
//               <div
//                 key={index}
//                 className={`flex ${message.user === "You" || message.selectedPersonId === loginId ? "justify-end" : "justify-start"}`}
//               >
//                 <div
//                   className={`max-w-xs p-3 rounded-lg text-sm shadow-md ${
//                     message.user === "You" || message.selectedPersonId === selectedPersonId
//                       ? "bg-blue-300 text-white rounded-br-none"
//                       : "bg-gray-200 text-gray-700 rounded-bl-none"
//                   }`}
//                 >
