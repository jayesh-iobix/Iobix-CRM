              ...
              {activeTab === 1 && (
                ...
                <div className="bg-white p-3 rounded-lg">
                  ...
                  <div className="grid overflow-auto">
                    <p className="text-lg font-semibold mb-3 text-gray-800">Products</p>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex flex-col items-end space-y-1">
                      {(formData.taxBreakdowns || []).map((item, index) => (
                        <div key={index} className="flex gap-4 justify-end w-full sm:w-1/2 lg:w-1/3 text-sm text-gray-800">
