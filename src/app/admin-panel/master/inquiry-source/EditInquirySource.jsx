...
const EditInquirySource = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // console.log(inquirySource.data);
      setInquirySourceName(inquirySource.data.inquirySourceName);
      setIsActive(inquirySource.data.isActive); // Assuming the department object contains isActive
    };
    fetchData();
  }, [id]);
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        console.error('Error Editing inquiry source:', error);
        alert('Failed to edit inquiry source.');
      }
        ...
        <form onSubmit={handleSubmit} className="container">
          <div className="-mx-4 px-10 mt- flex flex-wrap">
            <div className="w-full mb-2 px-3 md:w-1/2 lg:w-1/2">
              ...
              <input
                type="text"
                placeholder="Inquiry Type Source"
              ...
              {errors.inquirySourceName && (
                <p className="text-red-500 text-xs">{errors.inquirySourceName}</p>
              )}
            </div>
