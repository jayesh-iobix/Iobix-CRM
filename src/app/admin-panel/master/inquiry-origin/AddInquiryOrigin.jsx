...
const AddInquiryOrigin = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      if (validateForm()) {
        try {
          const response = await InquiryOriginService.addInquiryOrigin(inquiryOriginData);
            ...
            <div className='-mx-4 px-10 mt- flex flex-wrap'>
              <div className='w-full mb-2 px-3 md:w-1/2 lg:w-1/2'>
                ...
                <input
                  ...
                  autoFocus
                />
                {errors.inquiryOriginName  && <p className="text-red-500 text-xs">{errors.inquiryOriginName }</p>}
