...
const InquiryPermissionList = () => {
  ...
  const deleteInquiryPermission = async () => {
    ...
    try {
      ...
      if (response.status === 1) {
        setInquiryPermissionList((prevInquiryPermission) =>
          prevInquiryPermission.filter(
      ...
      console.error("Error deleting inquiry permission:", error);
      alert("Failed to delete inquiry permission");
    }
  };
  ...
  const handleCheckboxChange = async (checked, inquiryPermissionId , item) => {
      ...
      setInquiryPermissionList(updatedInquiryOrigin); // Update the state immediately
      ...
      try {
        ...
        const updatedInquiryOrigin = await InquiryPermissionService.updateInquiryPermission(
          inquiryPermissionId ,
          inquiryOriginData
        );
    ...
    <>
      <div className="flex justify-between items-center my-3">
        ...
        <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
          <Link
            to="/master/userinquirypermission-list/add-userinquirypermission"
                  ...
                  <td className="py-3 pr-8 text-right">
                    <div className="flex justify-end">
                      ...
                      <button className="text-blue-500 hover:text-blue-700 pr-3">
                        ...
                        >
                          <Link
                            to={`/master/userinquirypermission-list/edit-userinquirypermission/${item.userId}`}
