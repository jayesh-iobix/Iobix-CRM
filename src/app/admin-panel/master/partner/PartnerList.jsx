...
const PartnerList = () => {
  ...
  //   try {
  //     const response = await Partnerservice.deleteEmployee(employeeId);
  //     if (response.status === 1) {
  //       setFilteredPartners((prevPartners) =>
  //         prevPartners.filter((employee) => employee.employeeId !== employeeId)
  //       );
  ...
  const deleteEmployee = async () => {
    ...
    try {
      const response = await Partnerservice.deleteEmployee(deleteId);
      if (response.status === 1) {
        setFilteredPartners((prevPartners) =>
          prevPartners.filter((employee) => employee.employeeId !== deleteId)
        );
