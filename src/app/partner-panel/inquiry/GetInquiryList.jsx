    ...
    const fetchInquiries = async () => {
      try {
        if (role === "partner") {
          ...
          const result = await InquiryService.getCompanyInquiryFromIbx();
          setInquiries(result.data);
          setFilteredInquiries(result.data);
          setTotalItems(result.data.length);
        } else {
        ...
        // const result = await InquiryService.getInquiryFromIbx();
        // setInquiries(result.data);
        // setFilteredInquiries(result.data);
        // setTotalItems(result.data.length);
      } catch (error) {
      ...
      <div className="flex justify-between items-center my-3">
        ...
        {/* <div className="flex">
          <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            <Link
              to="/partner/inquiry-list/add-inquiry"
                  ...
                  <td className="py-3 px-4">
                    <div className="flex gap-2">
                      ...
                      {/* <motion.button
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                        onClick={() => handleDeleteClick(item.inquiryRegistrationId)}
                      ...
                      {openDropdown === item.inquiryRegistrationId && (
                        ...
                        >
                          <ul className="py-2 text-sm text-gray-800 cursor-pointer dark:text-gray-200">
                            <li>
                              <span
                                // onClick={() => handleTaskStartAndEndDate(item)}
